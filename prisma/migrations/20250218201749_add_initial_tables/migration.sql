...
-- AddForeignKey
ALTER TABLE "OrderProduct" ADD CONSTRAINT "OrderProduct_productsId_fkey" FOREIGN KEY ("productsId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
