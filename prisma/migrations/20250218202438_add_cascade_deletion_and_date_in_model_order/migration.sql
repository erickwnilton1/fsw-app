...
-- DropForeignKey
ALTER TABLE "OrderProduct" DROP CONSTRAINT "OrderProduct_productsId_fkey";
...
-- AddForeignKey
ALTER TABLE "OrderProduct" ADD CONSTRAINT "OrderProduct_productsId_fkey" FOREIGN KEY ("productsId") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;
